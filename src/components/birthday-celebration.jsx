  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        ...
        <h3 className="text-2xl sm:text-3xl font-bold text-center text-pink-600 mt-2">To My Raspberry Pi</h3>
      </motion.div>
      ...
      >
        <div className="text-center">
          ...
          <div className="flex justify-center items-center gap-2">
            <p className="text-pink-600 font-medium">Let’s always stay like this... together, forever 🫶 <br />Happy Birthday! — From Aman 🎂✨</p>
          </div>
        </div>
      </motion.div>
    </div>
